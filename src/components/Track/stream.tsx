...
function Duration({ duration, isActive }:IDuration) {
...
interface ITrackStream{
    ...
    activeDurationFilterType: string,
...
const TrackStream = observer(({
    ...
    const onActionInvoke = () => {
        onActivateTrack(activity.id);
    }
    
    return (
      <div className={trackClass}>
        <div className="track-artwork">
          <ArtworkAction action={onActionInvoke} className={playClass} isVisible={isVisible}>
...
function TrackIcon({ trackCount }:{trackCount:any}) {
...
function RepostIcon({ repostCount }:{repostCount:any}) {
